...
def IG1LS():
    ...
    global sumaFO, eficienciaor, eficienciaconsultas, anestesiapaciente, tminespera
    ...
    def leerexcel():
            ...
            global estadooriginal, pacientesoriginales, anestesiapaciente, tminespera
            ...
            while x<len(tiempoacump):
                ...
                x=x+1
            anestesiapaciente=pd.read_csv('pacientes.csv',sep=';',header=None,usecols=[17]).to_numpy()
            anestesiapaciente=list(int(x) for [x] in anestesiapaciente)
            tminespera=pd.read_csv('pacientes.csv',sep=';',header=None,usecols=[18]).to_numpy()
            tminespera=list(int(x) for [x] in tminespera)
    def cajanegra(secuencia,cc):
        
        global hcor, hcc, anestesiapaciente, tminespera, continuidad, numc, numor, horasq, wt,we,wc,wu,ctor, ctcc, cirujanos, asistentesor, cirjasocPAE, cirjasocOR, cirujanosor, ctconsultas, ctor, pacientes, pacientesaborrar, pacientesconsultas, pacientesor, tiempoacum
        global listaciruj, listaasist, listapacs
        def asignacion(secuencia,cc):
            global pacientesconsultas, pacientesor, cirujanosor, anestesiapaciente, tminespera,asistentesor, ctconsultas, ctor, hcor, hcc, continuidad
            pacientesconsultas = [[]]
            x=0
            while x<numc-1:
            ...
            def busquedaPAE (paciente):
                ...
                while j<len(cirujanosdelaunidad):
                    ...
                    if asignadoenconsulta!='NaN' and dispcons[asignadoenconsulta][dia]>0:#el cirujano sí está asignado a la consulta asignadoenconsulta
            ...
            def busquedaPOSTOP (paciente):
                ...
                if asignadoenconsulta!='NaN' and asignadoenOR=='NaN'  and descanso[cirjasocOR[paciente],dia]==0 and dispcons[asignadoenconsulta][dia]>0:#el cirujano sí está asignado a la consulta asignadoenconsulta
            ...
            def busquedaOR(paciente):
                global  tminespera, anestesiapaciente
                ...
                if hs[paciente]==0:#si no necesitamos asistente, se haría con el mismo algoritmo de buscar consulta:
                     ...
                     while j<len(cirujanosexpunidad):
                         ...
                         if asignadoenOR!='NaN' and anestesiaq[asignadoenOR]==[anestesiapaciente[paciente]]:#el cirujano sí está asignado a la OR asignadoenOR
                     ...
                     if flagyatieneOR==0:#si no tiene OR en toda la semana ningún cirujano, se le asigna al primero el primer hueco libre
                         ...
                         while j<numor:
                             ...
                             if ctor[j][-1]==0 and dispq[j][dia]==1 and anestesiaq[j]==[anestesiapaciente[paciente]]:#eL OR está libre, no tiene ninguna operación programada y está disponible
                                 x=0
                    ...
                    for i in cirujanosexpunidad:
                        ...
                        if asignadoenOR!='NaN' and anestesiaq[asignadoenOR]==[anestesiapaciente[paciente]]:#el cirujano sí está asignado ese día en un quirófano
                    ...
                    if flagyatieneasist==0: #hemos probado todos los cirujanos pero no hay ninguno ya asignado a un OR durante la semana. Hay que buscarle nuevo hueco
                        ...
                        for i in cirujanosexpunidad:
                            ...
                            while x<numor:
                                ...
                                if asignadoenconsulta=='NaN' and (asignadodia(i,'OR')=='NaN' or asignadodia(i,'OR')==x ) and anestesiaq[x]==[anestesiapaciente[paciente]]:#comprobamos que el ciruj no está en ninguna consulta ese día
                                    #print(ctor[dia][x][-1])
            ...
            global pacientesaborrar, listaid, listafecha, listacirujano, listapaciente, listaconsulta, listaconsultapae, listaconsultapost, listaquirofano, listadia, listatipo, listadescripcion
            pacientesaborrar=[]
            petapauno=0
            continuidad=0
            for k in pacientes:
            ...
            for k in range(len(secuencia)): #x es el indice del paciente
                ...
                if estado[indice(pacientes,secuencia[k])]==3 :
                    ...
                    if retorno!='NaN'and tiempoacum[indice(pacientes,secuencia[k])]>=tminespera[indice(pacientes,secuencia[k])]:
                        pacientesconsultas[retorno[0]].append(secuencia[k])
    ...
    def cajanegrasecuencia(secuencia):  
        global hcor, hcc, anestesiapaciente, tminespera, continuidad, numc, numor, horasq, ctor, wt,we,wc,wu,ctcc, cirujanos, asistentesor, cirjasocPAE, cirjasocOR, cirujanosor, ctconsultas, ctor, pacientes, pacientesaborrar, pacientesconsultas, pacientesor, tiempoacum
        global listaciruj, listaasist, listapacs
        def asignacion(secuencia):
            global pacientesconsultas, cirujanosconsultas, anestesiapaciente, tminespera, pacientesor, cirujanosor, asistentesor, ctconsultas, ctor, hcor, hcc, continuidad
            pacientesconsultas = [[]]
            cirujanosconsultas=[[]]
            x=0
            while x<numc-1:
            ...
            def busquedaPAE (paciente):
                ...
                while j<len(cirujanosdelaunidad):
                    ...
                    asignadoenconsulta = asignadodia(cirujanosdelaunidad[j],'consulta')
                    if asignadoenconsulta!='NaN':#el cirujano sí está asignado a la consulta asignadoenconsulta
                ...
                if flagyatieneconsulta==0:#si no tiene consulta en toda la semana ningún cirujano, se le asigna al primero la primera consulta libre
                    ...
                    while j<len(cirujanosconsultas):
                        if cirujanosconsultas[j]==[] and dispcons[j][dia]>0:#si la consulta está libre
                            x=0
                            for x in cirujanosdelaunidad:
                                if asignadodia(x, 'OR')=='NaN' :#and (asignadodia(x, 'consulta', dia)=='NaN' or asignadodia(x, 'consulta', dia)==j):
            ...
            def busquedaPOSTOP (paciente):
                ...
                asignadoenconsulta=asignadodia(cirjasocOR[paciente],'consulta')
                asignadoenOR = asignadodia(cirjasocOR[paciente],'OR')
                if asignadoenconsulta!='NaN' and asignadoenOR=='NaN' and descanso[cirjasocOR[paciente],dia]==0:#el cirujano sí está asignado a la consulta asignadoenconsulta
                    if ctconsultas[asignadoenconsulta][-1]+dc[paciente]<=dispcons[asignadoenconsulta][dia]/60:#ponemos h de consulta al dia
                        return [asignadoenconsulta,cirjasocOR[paciente]]
                        flagyatieneconsulta=1
                if flagyatieneconsulta==0:#e ciruj asoc no está en ninguna consulta ningún día
                    ...
                    while j<len(cirujanosconsultas):
                        if  cirujanosconsultas[j]==[] and dispcons[j][dia]>0:#este es la consulta donde se asignará el cirujano
            ...
            def busquedaOR(paciente):
                ...
                if hs[paciente]==0:#si no necesitamos asistente, se haría con el mismo algoritmo de buscar consulta:
                     ...
                     if flagyatieneOR==0:#si no tiene OR en toda la semana ningún cirujano, se le asigna al primero el primer hueco libre
                         ...
                         while j<numor:
                             # print('los cirujanos no tienen consulta asignada con hueco en la semana, así que se coge el primer hueco libre y se ve si algun ciruj puede')
                             if ctor[j][-1]==0 and dispq[j][dia]==1 and anestesiaq[j]==[anestesiapaciente[paciente]]:#eL OR está libre, no tiene ninguna operación programada
                                 x=0
                                 for x in cirujanosexpunidad:
                                     # print('probamos con el ciruj',x)
                                     # print('asignadodia',asignadodia(x, 'consulta'))
                    ...
                    if flagyatieneasist==0: #hemos probado todos los cirujanos pero no hay ninguno ya asignado a un OR durante la semana. Hay que buscarle nuevo hueco
                        ...
                        for i in cirujanosexpunidad:
                            ...
                            while x<numor:
                                ...
                                if asignadoenconsulta=='NaN' and (asignadodia(i,'OR')=='NaN' or asignadodia(i,'OR')==x ) and anestesiaq[x]==[anestesiapaciente[paciente]]:#comprobamos que el ciruj no está en ninguna consulta ese día
                                    #print(ctor[dia][x][-1])
                                    if ctor[x][-1]==0 and dispq[x][dia]==1:#le asignamos este OR
                                    #buscamos un asistente
                                        # print('hay hueco')
                                        for k in asistexp:
                                            # print('probamos con el asist {}, cirujanos {}, asignado en consulta? {} asignado en OR? {}'.format(k,i,asignadodia(k,'consulta'),asignadodia(k,'OR')))
    ...
    def actualizarexcel(pacientesaborrar):
        ...
        while x<len(pacientes):
            ...
            x=x+1
        print('PACIENTESSSSSSS', pacientes)
        nuevodataframepacientes = pd.DataFrame({'Número paciente':pacientes,
                                        ...
                                        'anestesia':anestesiapaciente,
                                        'tminespera': tminespera
                                        })
    ...
    dispq=pd.read_csv('quirofanos.csv',sep=';',header=None,nrows=numor, skiprows=1, usecols=list(range(0,ht)) ).to_numpy()
    anestesiaq=pd.read_csv('quirofanos.csv',sep=';',header=None,nrows=1, usecols=list(range(0,numor)) ).to_numpy()
    anestesiaq=anestesiaq.transpose()
    anestesiaq=anestesiaq.tolist()
...
eficienciaor=0
# original=r"D:\Documents\ETSI\EXTENSIONTFG\A1\instancia.xlsx"
# nuevo=r"D:\Documents\ETSI\EXTENSIONTFG\A1\data.xlsx"
