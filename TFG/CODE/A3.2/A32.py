...
def IG1LS():
    ...
    global anestesiapaciente, tminespera, anestesiaq
    ...
    def leerexcel():
            ...
            global estadooriginal, pacientesoriginales, anestesiapaciente, tminespera, anestesiaq
    ...
    def cajanegra(secuencia,cc):
        ...
        global hcor, hcc, continuidad, tminespera, anestesiapaciente, numc, numor, horasq, wt,we,wc,wu,ctor, ctcc, cirujanos, asistentesor, cirjasocPAE, cirjasocOR, cirujanosor, ctconsultas, ctor, pacientes, pacientesaborrar, pacientesconsultas, pacientesor, tiempoacum
        global listaciruj, listaasist, listapacs
        def asignacion(secuencia,cc):
            global pacientesconsultas, pacientesor,  tminespera, anestesiapaciente,cirujanosor, asistentesor, ctconsultas, ctor, hcor, hcc, continuidad
            pacientesconsultas = [[]]
            x=0
            while x<numc-1:
    ...
    def cajanegrasecuencia(secuencia):  
        global hcor, hcc, continuidad, anestesiapaciente, tminespera, numc, numor, horasq, ctor, wt,we,wc,wu,ctcc, cirujanos, asistentesor, cirjasocPAE, cirjasocOR, cirujanosor, ctconsultas, ctor, pacientes, pacientesaborrar, pacientesconsultas, pacientesor, tiempoacum
        global listaciruj, listaasist, listapacs
        def asignacion(secuencia):
            global pacientesconsultas, cirujanosconsultas,  tminespera, anestesiapaciente,pacientesor, cirujanosor, asistentesor, ctconsultas, ctor, hcor, hcc, continuidad
            pacientesconsultas = [[]]
            cirujanosconsultas=[[]]
            x=0
            while x<numc-1:
