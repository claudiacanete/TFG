...
def IG1LS():
    ...
    global sumaFO, eficienciaor, eficienciaconsultas
                ...
                if hs[paciente]==0:#si no necesitamos asistente, se haría con el mismo algoritmo de buscar consulta:
                     ...
                     while j<len(cirujanosexpunidad):
                         ...
                         if asignadoenOR!='NaN':#el cirujano sí está asignado a la OR asignadoenOR
                             ...
                             if ctor[asignadoenOR][-1]+dq[paciente]<=horasq:
                     ...
                     if flagyatieneOR==0:#si no tiene OR en toda la semana ningún cirujano, se le asigna al primero el primer hueco libre
                         ...
                         while j<numor:
                             ...
                             j=j+1
                     if flagyatieneOR==0:
                         return 'NaN' #si el flag sigue, se ve que no hay hueco para la operacion para este paciente en toda la semana
                    ...
                    if flagyatieneasist==0:
                        ...
                        return'NaN' #si tras buscar todos los cirujanos posibles con todos los asistentes estentes en todos los huecos el flag sigue a 0,
        ...
        def asignacion(secuencia):
            ...
            def busquedaOR(paciente):
                ...
                if hs[paciente]==0:#si no necesitamos asistente, se haría con el mismo algoritmo de buscar consulta:
                    ...
                    if flagyatieneasist==0:
                        # print('NO HAY POSIBLE COMBINACION CIRUJANO ASISTENTE')
                        return'NaN' #si tras buscar todos los cirujanos posibles con todos los asistentes e                                  
            ###COMIENZO CODIGO###
